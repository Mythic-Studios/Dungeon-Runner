...
public class ChemistryTableScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final ChemistStationBlockEntity blockEntity;

    public ChemistryTableScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(pos), new ArrayPropertyDelegate(2));
    }

    public ChemistryTableScreenHandler(int syncId, PlayerInventory playerInventory,
                                       BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.CHEMISTRY_TABLE_SCREEN_HANDLER, syncId);
        checkSize((Inventory) blockEntity, 6);
        this.inventory = (Inventory) blockEntity;
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = ((ChemistStationBlockEntity) blockEntity);
        ...
        this.addSlot(new Slot(inventory, 5, 135, 34));
